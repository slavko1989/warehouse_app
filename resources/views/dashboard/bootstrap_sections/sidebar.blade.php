<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ url('dashboard/index') }}" target="_blank">
        <img src="{{ asset('assets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold text-white">Company Dashboard</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="{{ url('dashboard/index') }}">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="{{ url('dashboard/lead/index') }}">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="material-icons opacity-10">table_view</i>
              </div>
              <span class="nav-link-text ms-1">Team Lead</span>
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link text-white " href="{{ url('dashboard/emp_team/index') }}">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="material-icons opacity-10">table_view</i>
              </div>
              <span class="nav-link-text ms-1">Employees team</span>
            </a>
          </li>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{ url('dashboard/index') }}">
            ...
            <span class="nav-link-text ms-1">Employees Vacation</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{ url('dashboard/profile/signIn') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
